...
set_property PACKAGE_PIN W19 [get_ports {Do_btn}]
set_property IOSTANDARD LVCMOS33 [get_ports {Do_btn}]
set_property PACKAGE_PIN U18 [get_ports {Re_btn}]
set_property IOSTANDARD LVCMOS33 [get_ports {Re_btn}]
set_property PACKAGE_PIN T17 [get_ports {Mi_btn}]
set_property IOSTANDARD LVCMOS33 [get_ports {Mi_btn}]
set_property PACKAGE_PIN T18 [get_ports {voice_up_btn}]
set_property IOSTANDARD LVCMOS33 [get_ports {voice_up_btn}]
set_property PACKAGE_PIN U17 [get_ports {voice_down_btn}]
set_property IOSTANDARD LVCMOS33 [get_ports {voice_down_btn}]